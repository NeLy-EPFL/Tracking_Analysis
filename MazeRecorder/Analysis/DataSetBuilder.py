...
final_event_cutoff_path = Path("/mnt/upramdya_data/MD/MultiMazeRecorder/Datasets/250204_Summary_2")
final_event_cutoff_data_path = Path("/mnt/upramdya_data/MD/MultiMazeRecorder/Datasets/250204_Summary_2_Data")
...
for metric in metrics_list:
    pooled_dataset_path = final_event_cutoff_data_path / metric / f"250203_Pooled_{metric}.feather"
