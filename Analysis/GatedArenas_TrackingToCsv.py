...
DataPath = "/Volumes/Ramdya-Lab/DURRIEU_Matthias/Experimental_data/MultiSensory_Project/GatedArenas"
Data = pd.DataFrame()
            ...
            Out.append(
                {
                    ...
                    if ("Trained_Food_Starved_noWater" in dirpath)
                    else "Not starved",
                    "Test Starvation": "Overnight no Water"
                    if ("Test_Starved_noWater" in dirpath)
                    else "With Water",
