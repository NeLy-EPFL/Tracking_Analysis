...
for file in Files:
    ...
    # Use the code below if you want to preprocess the videos keeping only part of it.
    ...
    input_vidpath = file #TrimmedPath
    ...
    #Use the code below if you want to use background subtraction
    ...
    while (True):
        ...
        last = this
    #Replace loop above with one below if you use the background sub.
    #while True:
        # Capture frame-by-frame
    #    ret, frame = cap.read()
